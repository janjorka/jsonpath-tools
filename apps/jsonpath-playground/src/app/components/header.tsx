        ...
        <Flex justify="space-between">
            ...
            <Group pr="xs">
                <Tooltip label="GitHub Repository">
                    <ActionIcon variant="subtle" color="violet" size="lg" aria-label="GitHub Repository" visibleFrom="xs" component="a" href="https://github.com/janjorka/jsonpath-tools" target="_blank">
